...
CREATE TABLE `contact` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=25457 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `news` VALUES (18,'2015-02-19 00:00:00','Livraison à domicile','','Allée du Bio vous propose la livraison de vos commandes <strong>à domicile.</strong>\r\nCommandez par téléphone ou bien sur le site à l\'aide du bon de commande et nous assurons la livraison à domicile ou <b>la préparation de paniers à emporter</b>\r\n','/livreur - Copy 1-18.png',1),(19,'2015-03-19 00:00:00','Allée du Bio sur France Bleu Gironde','','<embed flashvars=\"audioUrl=http://www.alleedubio.fr/uploads/alleedubio.mp3\" height=\"27\" quality=\"best\" src=\"http://www.alleedubio.fr/inc/google-audio-player.swf\" type=\"application/x-shockwave-flash\" width=\"400\"></embed> ','/Screen_Shot_2015_03_19_at_18.01.30-.png',0),(21,'2015-04-24 00:00:00','Foire Expo de Bordeaux du 8 au 18 mai 2015','','Le magasin sera présent le dimanche 10 mai à la foire exposition de Bordeaux. Je ferai une démonstration culinaire avec des produits bio, sur le thème de l\'Inde.\r\nVous découvrirez des épices, des légumes et saveurs venues d\'Asie. Un délice pour le palet ! Première démonstration à 11 heures et deuxième à 15 heures. Venez nombreux ...','/Inde_epices_pt130710-21.jpg',1),(23,'2015-05-06 00:00:00','Fermeture exceptionnelle','','Le magasin sera fermé pour l\'Ascension : du jeudi 14 au samedi 16 mai inclus.','/97289914abeille_jpg-23.jpg',1);
...
-- Dump completed on 2015-05-16 15:24:15
